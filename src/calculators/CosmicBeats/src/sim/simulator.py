...
from ..sim.imanager import IManager
from ..sim.managerparallel import ManagerParallel
...
class Simulator:
    ...
    def call_RuntimeAPIs(self, _api: str, **_kwargs):
        """
    ...
    def get_SimEnv(self):
        return self.__orchestrator.get_SimEnv()

    def get_Topologies(self):
        return self.__orchestrator.get_Topologies()

    def get_SimStartTime(self):
        return self.__orchestrator.get_SimStartTime()

    def get_SimEndTime(self):
        return self.__orchestrator.get_SimEndTime()
