...
class Time:
    ...
    def round_to_nearest_second(self) -> 'Time':
        ...
        If the microsecond part of the datetime is 500,000 or above,
        it adds a second and resets the microsecond part to zero.
        Otherwise, it just resets the microsecond part to zero.
        """
...
class Location:
    ...
    def multiple_from_lat_long(latLst: 'List[float]', lonLst: 'List[float]', elevLst: 'List[float]') -> 'List[Location]':
        ...
        # Idk why they have this order, but it takes lon, lat. Also, elev is distance above WGS reference,
        # so like 0 is sea level
